...
3) Access the `workbench` named `audio-to-text-p1744951033122-notebook`.
...
5) In the terminal, run `cd audio-to-text-p1744951033122` to navigate to your sample app's directory.
